...
<div class="col-lg-9 col-sm-9">
    <div class="card hovercard">
        ...
        <div class="useravatar">
            <img alt="" src="https://cdn.onlinewebfonts.com/svg/img_351450.png">
        </div>
        <div class="card-info"> <span class="card-title">Porudzbine</span>
                        ...
                        <div class="widget-content">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions">
                                        <a href="order-change-status?accepted=1&order_id=<?php echo $order->id ?>" class="btn btn-small btn-primary">
            ...
            <div class="tab-pane fade in" id="tab2">
                ...
                <?php foreach ($accepted as $aorder){ ?>
                    <tr>
                        ...
                        <td class="td-actions">
                            <a href="order-change-status?finished=1&order_id=<?php echo $aorder->id ?>" class="btn btn-small btn-primary">
                                <i class="fa fa-check"></i>
                            </a>
                        </td>
                    </tr>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php foreach ($finished as $aorder){ ?>
                        <tr>
                            ...
                            <td><?php echo $aorder->total_price; ?></td>
                            <td class="td-actions">
                                <p  class="btn btn-small btn-success">
                                    <i class="fa fa-check"></i>
                                </p>
                            </td>
                        </tr>
